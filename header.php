        ...
        <div class="container">
                ...
                <div class="col-md-12 col-lg-9 offset-lg-0 col-xl-7 offset-xl-2 ">
                    <div class="header__contacts">
                        <div class="header__contacts-item">
                            ...
                            <a href="mailto:<?php the_field('mail', 54)?>" class="header__contacts-mail"><?php the_field('mail', 54)?></a>
                        </div>
                        <div class="header__contacts-item">
                            ...
                            <div class="header__contacts-tel">
                                <a href="tel:<?php the_field('number_1', 54)?>"><?php the_field('number_1', 54)?></a>
                                <a href="tel:<?php the_field('number_2', 54)?>"><?php the_field('number_2', 54)?></a>
                            </div>
                        </div>
                        <div class="header__contacts-item">
                            <img src="<?php echo bloginfo('template_url'); ?>/assets/img/icons/svg/pointer.svg" alt="указатель" class="header__contacts-logo">
                            <address><?php the_field('address', 54)?></address>
                        </div>
                    </div>
                </div>
            </div>
            <nav class="row" data-slide="1">
                ...
                <!-- <ul class="header__nav">
                    <li>
                        <a class="header__nav-item" href="/">Про компанию</a>
                    </li>
                    <li>
                        <a class="header__nav-item" href="nasha-komanda">Наша команда</a>
                    </li>
                    <li>
                        <a class="header__nav-item" href="igrushki">Игрушки</a>
                    </li>
                    <li>
                        <a class="header__nav-item" href="nasha-istoriya">Наша история</a>
                    </li>
                    <li>
                        <a class="header__nav-item" href="kontakty">Контакты и отзывы</a>
                    </li>
                </ul> -->
            </nav>
        </div>
