...
<div class="contacts" id="contacts">
    <h1 class="title"><?php the_field('address_title', 54) ?></h1>
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
                <div class="contacts__descr underlined">
                    <?php the_field('address_text', 54) ?>
                </div>
            </div>
            <div class="col-lg-6">
            ...
            <div class="col-md-6">
                ...
                <div class="contacts__info">
                    ...
                    <div class="contacts__mail">
                        ...
                        <a href="mailto:<?php the_field('mail', 54) ?>"><?php the_field('mail', 54) ?></a>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                ...
                <div class="contacts__feed"><?php
                echo do_shortcode('[contact-form-7 id="171" title="Форма отзывов"]');
                ?></div>                           
